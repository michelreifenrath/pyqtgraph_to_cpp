#!/usr/bin/env python3
"""Pinned ImageView view-transform oracle fixture checker for issue #409."""
...
SCRIPT = ROOT / "oracle" / "scripts" / "generate_P409_imageview_view_oracle.py"
...
def main() -> int:
    ...
    spec = importlib.util.spec_from_file_location("generate_P409_imageview_view_oracle", SCRIPT)
    ...
    print(
        "P409 ImageView view oracle fixture ok: "
