#!/usr/bin/env python3
"""Pinned ImageView ROI plot oracle fixture checker for issue #413."""
...
SCRIPT = ROOT / "oracle" / "scripts" / "generate_P413_imageview_roi_plot_oracle.py"
...
def main() -> int:
    ...
    spec = importlib.util.spec_from_file_location("generate_P413_imageview_roi_plot_oracle", SCRIPT)
    ...
    print(
        "P413 ImageView ROI plot oracle fixture ok: "
