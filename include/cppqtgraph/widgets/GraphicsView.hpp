...
signals:
    void sigDeviceRangeChanged(cppqtgraph::widgets::GraphicsView* view, const QRectF& range);
    void sigDeviceTransformChanged(cppqtgraph::widgets::GraphicsView* view);
    void sigMouseReleased(QMouseEvent* event);
    void sigSceneMouseMoved(const QPointF& scenePos);
    void sigScaleChanged(cppqtgraph::widgets::GraphicsView* view);
