...
signals:
    void sigLookupTableChanged(cppqtgraph::graphicsItems::HistogramLUTItem* item);
    void sigLevelsChanged(cppqtgraph::graphicsItems::HistogramLUTItem* item);
    void sigLevelChangeFinished(cppqtgraph::graphicsItems::HistogramLUTItem* item);
