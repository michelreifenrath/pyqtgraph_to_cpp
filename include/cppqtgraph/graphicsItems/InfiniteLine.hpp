...
class InfiniteLine : public GraphicsObject, public cppqtgraph::GraphicsScene::GraphicsSceneEventHandler {
    Q_OBJECT
...
signals:
    ...
    void sigPositionChanged(cppqtgraph::graphicsItems::InfiniteLine* line);
    void sigClicked(cppqtgraph::graphicsItems::InfiniteLine* line, cppqtgraph::GraphicsScene::MouseClickEvent* event);
