...
#ifndef CPPQTGRAPH_ENABLE_QT_COLOR
#define CPPQTGRAPH_ENABLE_QT_COLOR 0
#endif

#if CPPQTGRAPH_ENABLE_QT_COLOR
...
#include <QPen>
#include <QString>
#define CPPQTGRAPH_HAS_QT_COLOR_HEADERS 1
...
#define CPPQTGRAPH_HAS_QT_COLOR_HEADERS 1
#else
#error "CPPQTGRAPH_ENABLE_QT_COLOR requires Qt QBrush, QColor, QPainterPath, QPen, and QString headers"
#endif
#else
#define CPPQTGRAPH_HAS_QT_COLOR_HEADERS 0
#endif
