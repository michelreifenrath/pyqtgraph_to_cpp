...
class LinearRegionItem : public GraphicsObject, public pyqtgraph::GraphicsScene::GraphicsSceneEventHandler {
    Q_OBJECT
...
signals:
    void sigRegionChangeFinished(pyqtgraph::graphicsItems::LinearRegionItem* region);
    void sigRegionChanged(pyqtgraph::graphicsItems::LinearRegionItem* region);
