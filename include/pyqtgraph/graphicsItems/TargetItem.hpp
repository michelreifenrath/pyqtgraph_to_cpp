...
class TargetItem : public GraphicsObject, public pyqtgraph::GraphicsScene::GraphicsSceneEventHandler {
    Q_OBJECT
...
signals:
    void sigPositionChanged(pyqtgraph::graphicsItems::TargetItem* target);
    void sigPositionChangeFinished(pyqtgraph::graphicsItems::TargetItem* target);
