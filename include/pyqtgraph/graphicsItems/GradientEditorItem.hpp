...
class Tick final : public GraphicsWidget, public pyqtgraph::GraphicsScene::GraphicsSceneEventHandler {
    Q_OBJECT
...
signals:
    ...
    void sigClicked(Tick* tick, pyqtgraph::GraphicsScene::MouseClickEvent* event);
...
class TickSliderItem : public GraphicsWidget, public pyqtgraph::GraphicsScene::GraphicsSceneEventHandler {
    Q_OBJECT
...
protected:
    ...
    virtual void tickClicked(Tick* tick, pyqtgraph::GraphicsScene::MouseClickEvent* event);
...
protected:
    void tickClicked(Tick* tick, pyqtgraph::GraphicsScene::MouseClickEvent* event) override;
