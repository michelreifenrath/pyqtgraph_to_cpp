...
function(pyqtgraph_cpp_configure_options)
    ...
    if(Qt6_FOUND AND TARGET Qt6::Core AND TARGET Qt6::Test)
    ...
    if(PYQTGRAPH_CPP_REQUIRE_QT AND NOT _pyqtgraph_cpp_has_qt)
        message(FATAL_ERROR "Qt 6 Core and Test are required for the default PGBOOT-001 test baseline. Install Qt 6 with Core and Test components, or configure with -DPYQTGRAPH_CPP_REQUIRE_QT=OFF only if intentionally skipping Qt-dependent test targets.")
    endif()
    ...
    set(PYQTGRAPH_CPP_HAS_QT "${_pyqtgraph_cpp_has_qt}" CACHE INTERNAL "Qt 6 Core/Test discovery result" FORCE)
    set(PYQTGRAPH_CPP_HAS_OPENCV "${_pyqtgraph_cpp_has_opencv}" CACHE INTERNAL "OpenCV 4 discovery result" FORCE)

    message(STATUS "pyqtgraph-cpp Qt 6 Core/Test available: ${PYQTGRAPH_CPP_HAS_QT}")
