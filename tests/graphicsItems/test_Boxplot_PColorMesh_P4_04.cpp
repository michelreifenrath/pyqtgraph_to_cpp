...
bool exercisePColorMesh(QJsonObject& report)
{
    ...
    CHECK(nearly(item.width(), 3.0));
    CHECK(nearly(item.height(), 2.0));
    CHECK(nearly(item.dataBounds(0).first, 0.0));
    CHECK(nearly(item.dataBounds(0).second, 3.0));
    CHECK(nearly(item.dataBounds(1).first, 0.0));
    CHECK(nearly(item.dataBounds(1).second, 2.0));
    ...
    CHECK(cells[2].polygon[0] == QPointF(2.0, 0.0));
    CHECK(cells[2].polygon[2] == QPointF(3.0, 1.0));
    ...
    CHECK(cells[3].polygon[1] == QPointF(1.0, 2.0));
    CHECK(cells[3].polygon[2] == QPointF(2.0, 2.0));
    CHECK(cells[3].polygon[3] == QPointF(2.0, 1.0));
    ...
    CHECK(nearly(item.boundingRect().right(), 5.0));
    CHECK(nearly(item.boundingRect().top(), -2.0));
    CHECK(nearly(item.boundingRect().bottom(), 4.0));
