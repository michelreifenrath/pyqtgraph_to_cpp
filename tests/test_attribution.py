...
def test_removed_root_license_documents_are_not_required() -> None:
...
def test_generated_source_without_generation_inputs_fails(tmp_path: Path) -> None:
    write(
        ...
        "// Generated by oracle/scripts/generate_numeric_oracles.py\n"
...
def test_generated_source_with_placeholder_generator_fails(tmp_path: Path) -> None:
    write(
        ...
        "// Inputs: oracle/fixtures/numeric_oracles.yaml\n"
        "// Do not edit manually\n"
        "int generated_symbol() { return 0; }\n",
    )
...
def test_generated_source_with_source_field_still_requires_inputs(
    ...
    write(
        tmp_path / "src" / "cppqtgraph" / "generated.cpp",
        "// Generated by oracle/scripts/generate_numeric_oracles.py\n"
        "// Source: oracle/fixtures/numeric_oracles.yaml\n"
        "// Do not edit manually\n"
        "int generated_symbol() { return 0; }\n",
    )
