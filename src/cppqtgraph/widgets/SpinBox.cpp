...
#include "../../../include/cppqtgraph/widgets/SpinBox.hpp"
    ...
    : QAbstractSpinBox(parent)
{
    ...
    changeProxy_ = new cppqtgraph::SignalProxy(opts_.delay, 0.0, false, this);
    connect(this, &SpinBox::sigValueChanging, changeProxy_, [this](SpinBox*, double) {
        changeProxy_->signalReceived();
    });
    connect(changeProxy_, &cppqtgraph::SignalProxy::sigDelayed, this, &SpinBox::delayedChange);
