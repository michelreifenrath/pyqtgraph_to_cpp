...
void Tick::hoverEvent(cppqtgraph::GraphicsScene::HoverEvent* event)
{
...
void Tick::mouseClickEvent(cppqtgraph::GraphicsScene::MouseClickEvent* event)
{
    if (event == nullptr) {
        return;
    }
...
void Tick::mouseDragEvent(cppqtgraph::GraphicsScene::MouseDragEvent* event)
{
...
void TickSliderItem::hoverEvent(cppqtgraph::GraphicsScene::HoverEvent* event)
{
...
void TickSliderItem::mouseClickEvent(cppqtgraph::GraphicsScene::MouseClickEvent* event)
{
    if (event == nullptr) {
        return;
    }
...
void TickSliderItem::tickClicked(Tick* tick, cppqtgraph::GraphicsScene::MouseClickEvent* event)
{
...
void TickSliderItem::connectTick(Tick* tick)
{
    ...
    QObject::connect(tick, &Tick::sigClicked, this, [this](Tick* clickedTick, cppqtgraph::GraphicsScene::MouseClickEvent* event) {
...
void GradientEditorItem::tickClicked(Tick* tick, cppqtgraph::GraphicsScene::MouseClickEvent* event)
{
