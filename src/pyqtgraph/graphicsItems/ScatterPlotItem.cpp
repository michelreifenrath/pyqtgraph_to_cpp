...
#include "../../../include/pyqtgraph/graphicsItems/ScatterPlotItem.hpp"
...
{
    drawSymbolPath(painter, pyqtgraph::symbolPath(symbol), size, pen, brush);
}
...
{
    return renderSymbolPath(pyqtgraph::symbolPath(symbol), size, pen, brush, devicePixelRatio);
}
