...
#include "../../../include/pyqtgraph/graphicsItems/InfiniteLine.hpp"
#include "../../../include/pyqtgraph/graphicsItems/LinearRegionItem.hpp"
#include "../../../include/pyqtgraph/graphicsItems/TargetItem.hpp"
...
void InfiniteLine::hoverEvent(pyqtgraph::GraphicsScene::HoverEvent* event)
{
...
void InfiniteLine::mouseClickEvent(pyqtgraph::GraphicsScene::MouseClickEvent* event)
{
...
void InfiniteLine::mouseDragEvent(pyqtgraph::GraphicsScene::MouseDragEvent* event)
{
...
void LinearRegionItem::hoverEvent(pyqtgraph::GraphicsScene::HoverEvent* event)
{
...
void LinearRegionItem::mouseClickEvent(pyqtgraph::GraphicsScene::MouseClickEvent* event)
{
    if (event != nullptr && moving_ && event->button() == Qt::RightButton) {
        event->accept(this);
        blockLineSignal_ = true;
...
void LinearRegionItem::mouseDragEvent(pyqtgraph::GraphicsScene::MouseDragEvent* event)
{
    if (event == nullptr || !movable_ || event->button() != Qt::LeftButton) {
        return;
    }
...
void TargetItem::hoverEvent(pyqtgraph::GraphicsScene::HoverEvent* event)
{
    if (event != nullptr && movable_ && !event->isExit() && event->acceptDrags(Qt::LeftButton, this)) {
        setMouseHover(true);
    } else {
...
void TargetItem::mouseClickEvent(pyqtgraph::GraphicsScene::MouseClickEvent* event)
{
    if (event != nullptr && moving_ && event->button() == Qt::RightButton) {
        event->accept(this);
        moving_ = false;
...
void TargetItem::mouseDragEvent(pyqtgraph::GraphicsScene::MouseDragEvent* event)
{
    if (event == nullptr || !movable_ || event->button() != Qt::LeftButton) {
        return;
    }
