...
pyqtgraph::GraphicsScene::GraphicsSceneEventHandler* eventHandlerFor(QGraphicsItem* item)
{
    return dynamic_cast<pyqtgraph::GraphicsScene::GraphicsSceneEventHandler*>(item);
}
