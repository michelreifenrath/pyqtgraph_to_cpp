...
#include "../../../include/pyqtgraph/widgets/DiffTreeWidget.hpp"
...
{
    const QColor bad = pyqtgraph::mkColor(255, 200, 200);
    ...
    const QVariantList& path)
{
    ...
    const QBrush brush = pyqtgraph::mkBrush(bad);
...
{
    const QBrush brush = pyqtgraph::mkBrush(color);
