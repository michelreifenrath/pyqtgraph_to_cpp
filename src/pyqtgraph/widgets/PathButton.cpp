...
#include "../../../include/pyqtgraph/widgets/PathButton.hpp"
...
PathButton::PathButton(QWidget* parent)
    : QPushButton(parent)
    , pen_(pyqtgraph::mkPen(QStringLiteral("k")))
{
    setFixedSize(30, 30);
}
...
void PathButton::setPen(const QString& color)
{
    ...
    setPen(pyqtgraph::mkPen(resolved));
}
...
{
    setBrush(pyqtgraph::mkBrush(nullptr));
}
